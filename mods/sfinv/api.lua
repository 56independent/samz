...
local theme_inv = [[
		image[0,4.2;1,1;sfinv_hb_bg.png]
		image[1,4.2;1,1;sfinv_hb_bg.png]
		image[2,4.2;1,1;sfinv_hb_bg.png]
		image[3,4.2;1,1;sfinv_hb_bg.png]
		image[4,4.2;1,1;sfinv_hb_bg.png]
		image[5,4.2;1,1;sfinv_hb_bg.png]
		image[6,4.2;1,1;sfinv_hb_bg.png]
		image[7,4.2;1,1;sfinv_hb_bg.png]
		list[current_player;main;0,4.2;8,1;]
		list[current_player;main;0,5.35;8,3;8]
	]]
